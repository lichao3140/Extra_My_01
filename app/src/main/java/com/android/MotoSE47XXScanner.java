...
import com.android.auto.p160scan.barcodescanner.BaseScan;
...
public class MotoSE47XXScanner extends BaseScan implements
	...
	/*
	 * default boolean enabled: false ×¢£º´úÂë²»ÐèÉèÖÃÕâ¸öÌõÂë
	 */
	...
	/*
	 * default can use boolean enabled: false ×¢£º´úÂë²»ÐèÉèÖÃÕâ¸öÌõÂë
	 */
	 ...
	 * stripStartStopCharactersEnabled:false ×¢£º´úÂë²»ÐèÉèÖÃÕâ¸öÌõÂë
	 */
