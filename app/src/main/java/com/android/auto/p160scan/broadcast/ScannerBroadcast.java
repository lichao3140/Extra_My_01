...
import com.android.auto.p160scan.utility.ParamNum;
...
public class ScannerBroadcast extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (action.equals(ConstantUtil.KEY_RECEIVER_ACTION)
				|| action.equals(ConstantUtil.KEY_RECEIVER_FN_ACTION)
				|| action.equals(ConstantUtil.KEY_RECEIVER_F13_ACTION)
				|| action.equals(ConstantUtil.KEY_RECEIVER_F14_ACTION)
				|| action.equals(ConstantUtil.KEY_RECEIVER_F15_ACTION)) {
