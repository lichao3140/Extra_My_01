package com.android.auto.p160scan.utility;

public class ParamNum {
	/* Name Number Min Max Default */
	public static final int barcode = 0; // 0 1 1
	public static final int scankey = 1; // 0 1 1
	public static final int broadcast = 2; // 0 1 1
	public static final int beep = 3; // 0 1 1
	public static final int vibrate = 4; // 0 1 1
	public static final int terminator = 5; // 0 1 0
	public static final int power = 6; // 0 1 1
	public static final int charset = 7; // 0 1 0
	public static final int filterCharacter =8; // 0 1 0
	public static final int light = 9; // 0 1 0
	public static final int notice = 10; // 0 1 0
	public static final int icon = 11; // 0 1 0

	public static final int continuscan = 12; // 0 1 0

	public static final int startscan = 13; // 0 1 0
	public static final int stopscan = 14; // 0 1 0

	public static final int screenon = 15; // 0 1 0
	public static final int screenoff = 16; // 0 1 0

	public static final int cameraon = 17; // 0 1 0
	public static final int cameraoff = 18; // 0 1 0
	...
	public static final int lightsmode=39;
