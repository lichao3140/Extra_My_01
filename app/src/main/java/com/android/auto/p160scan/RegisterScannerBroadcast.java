...
import com.android.auto.p160scan.broadcast.ScannerBroadcast;
import com.android.auto.p160scan.broadcast.SettingBroadcast;
...
public class RegisterScannerBroadcast {
	...
	public void  RegisterScannerBroastReceiver(ScannerServices listen) {
		...
		scannerfilter.addAction(ConstantUtil.KEY_RECEIVER_FN_ACTION);
		scannerfilter.addAction(ConstantUtil.KEY_RECEIVER_F13_ACTION);
		scannerfilter.addAction(ConstantUtil.KEY_RECEIVER_F14_ACTION);
		scannerfilter.addAction(ConstantUtil.KEY_RECEIVER_F15_ACTION);
