...
import com.android.auto.p160scan.utility.Gather;
import com.android.auto.p160scan.utility.NoticeManager;
...
public class ScannerServices extends Service {
	...
	public class MyBinder implements CameraListener {
		...
		private static final int CAMERA_CLOSE = 0;// Ïà»ú´ò¿ª
		private static final int CAMERA_OPNEN = 1;// Ïà»ú¹Ø±Õ
